  ...
  return (
    ...
    >
      <div className="flex flex-col  justify-around flex-wrap items-center   max-w-[900px]">
        ...
        I deal with NFT development, the creation of smart contracts 
        and related applications. I am studying other topics including 
        Flutter development and Cybersecurity basics.
          <br />
          <br />
